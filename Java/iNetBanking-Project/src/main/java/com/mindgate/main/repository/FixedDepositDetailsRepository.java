...
public class FixedDepositDetailsRepository implements FixedDepositDetailsRepositoryInterface {
	...
	@Override
	public boolean addFixedDeposit(FixedDepositDetails fixedDepositDetails) {
		System.out.println("fixed" + fixedDepositDetails);
		Object[] parameters = { fixedDepositDetails.getUserDetails().getUserId(),
				fixedDepositDetails.getFixedDepositAmount(), fixedDepositDetails.getFixedDepositTenure(),
